...
- Current Phase: `Post-v1.0 — Agent orchestration / Git worktree sandbox provider spike`
- Active Slice: `Git Worktree Sandbox Provider Spike Over Acquired Leases (ACTIVE; proving deterministic worktree allocation over acquired edit lease lifecycle authority)`
