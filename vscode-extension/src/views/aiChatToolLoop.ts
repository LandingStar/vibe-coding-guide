...
function buildDecisionPrompt(
    ...
    return [
        ...
        'Before substantial task work begins, judge whether the task is large enough or split-worthy enough to need distinct Local Work lanes. If yes or uncertain, follow design_docs/tooling/local-work-lane-splitting/README.md; keep detailed lane split criteria in that standard, not in this prompt.',
        ...
        'Use localTrajectory addLane when a distinct work context must begin. Use localTrajectory addLanes when opening multiple distinct work contexts from the same source event. Use localTrajectory merge when a separate lane is ready to rejoin a target lane.',
