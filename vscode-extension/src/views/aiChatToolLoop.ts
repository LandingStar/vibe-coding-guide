...
function buildDecisionPrompt(
    ...
    return [
        ...
        'Use localTrajectory addLane as soon as one distinct work context must begin, not only after the main lane is already full. Use localTrajectory addLanes when opening multiple distinct work contexts from the same source event. Use localTrajectory merge when a separate lane is ready to rejoin a target lane.',
