...
export class ProgressGraphPreviewPanel implements vscode.Disposable {
    ...
    try {
      ...
      artifactModifiedTimeMs: previewStat ? previewStat.mtimeMs : null,
            ...
            schedulerOperatorWorkflow: schedulerOperatorWorkflow ?? {
              ...
              authorizationReadError: 'scheduler operator workflow state was not loaded',
  ...
  private _shellSignature(state: ProgressGraphPreviewState): string {
    return JSON.stringify({
      ...
      schedulerOperatorAuthorizationOk: state.schedulerOperatorWorkflow.authorizationReadback?.ok ?? null,
      schedulerOperatorAuthorizationTaskCount: state.schedulerOperatorWorkflow.authorizationReadback?.taskCount ?? null,
      schedulerOperatorAuthorizationEditLeaseTaskCount: state.schedulerOperatorWorkflow.authorizationReadback?.editLeaseTaskCount ?? null,
      schedulerOperatorAuthorizationLifecycleStates: state.schedulerOperatorWorkflow.authorizationReadback?.lifecycleStateCounts ?? null,
      schedulerOperatorAuthorizationSandboxStates: state.schedulerOperatorWorkflow.authorizationReadback?.sandboxAuthorizationStateCounts ?? null,
      schedulerOperatorAuthorizationTaskIds: state.schedulerOperatorWorkflow.authorizationReadback?.tasks.map((task) => task.taskId) ?? [],
      schedulerOperatorAuthorizationReadError: state.schedulerOperatorWorkflow.authorizationReadError,
